<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\chinling\public/../application/admin\view\chats\add.html";i:1537426498;s:54:"D:\chinling\public/../application/admin\view\base.html";i:1537427037;s:63:"D:\chinling\public/../application/admin\view\public\header.html";i:1534209611;s:60:"D:\chinling\public/../application/admin\view\public\nav.html";i:1534209611;}*/ ?>
 ...
 <ul class="bot">
   <?php if(is_array($daoh) || $daoh instanceof \think\Collection || $daoh instanceof \think\Paginator): if( count($daoh)==0 ) : echo "" ;else: foreach($daoh as $key=>$vo): if($vo['name'] == $action): ?>
    ...
    <div id="dcMain">
        ...
        <h3>添加大事件</h3>
        <form action="<?php echo url('chats/add'); ?>" id="chat_add" method="post">
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                <tr>
                    <td width="80" align="right">时间</td>
                    <td>
                        <input type="text" id="date" name="date" value="" size="40" class="inpMain" readonly />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="content" name="content" value="" size="40" class="inpMain" />
