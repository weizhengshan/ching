<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\chinling\public/../application/admin\view\auth_group\auth_gedit.html";i:1534209611;s:54:"D:\chinling\public/../application/admin\view\base.html";i:1534209609;s:63:"D:\chinling\public/../application/admin\view\public\header.html";i:1534209611;s:60:"D:\chinling\public/../application/admin\view\public\nav.html";i:1534209611;}*/ ?>
...
<div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">{$Think.config.ADMIN_TITLE}<b>></b><strong>修改权限</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
     <h3>修改权限</h3>
    <form action="" id="data_type" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" id="a_title" name="title" value="<?php echo $authgroups['title']; ?>" size="40" class="inpMain" />
...
var url="<?php echo url('admin/auth_group/auth_gedit'); ?>";
