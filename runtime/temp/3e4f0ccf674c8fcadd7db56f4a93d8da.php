<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\chinling\public/../application/admin\view\manage\manage_edit.html";i:1534209609;s:54:"D:\chinling\public/../application/admin\view\base.html";i:1534209609;s:63:"D:\chinling\public/../application/admin\view\public\header.html";i:1534209611;s:60:"D:\chinling\public/../application/admin\view\public\nav.html";i:1534209611;}*/ ?>
    ...
    <h3><a href="<?php echo url('admin/manage/manage_list'); ?>" class="actionBtn">返回列表</a>网站管理员</h3>
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" id="user_name" name="user_name" size="40" class="inpMain"  value="<?php echo $data['admin_username']; ?>" disabled="true"/>
      ...
      <tr>
       ...
       <td>
        <input type="text" id="email" name="email" size="40" class="inpMain" value="<?php echo $data['email']; ?>"/>
       ...
       <td>
        <input type="text" id="phone" name="phone"  size="40" class="inpMain" value="<?php echo $data['phone']; ?>" />
      ...
      <tr>
       ...
       <td>
        <input type="password" id="password" name="password" size="40" class="inpMain" value="<?php echo $data['admin_password']; ?>"/>
      ...
      <tr>
       ...
       <td>
        <select name="role_id" id="role_id" >	
			<?php if(is_array($roledata) || $roledata instanceof \think\Collection || $roledata instanceof \think\Paginator): if( count($roledata)==0 ) : echo "" ;else: foreach($roledata as $key=>$vo): ?>
			<option <?php if($data['role_id']==$vo['id']): ?> selected <?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
...
var url="<?php echo url('admin/manage/manage_edit'); ?>";
